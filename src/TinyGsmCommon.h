...
#define TINYGSM_VERSION "G0.9.17"
...
struct StatPrefferStore {
    String REC_UNREAD = F("REC UNREAD"); //Received unread messages
    String REC_READ   = F("REC READ");   //Received read messages
    String STO_UNSENT = F("STO UNSENT"); //Stored unsent messages
    String STO_SENT   = F("STO SENT");   //Stored sent messages
    String ALL        = F("ALL");        //All messages
} _statSMS;
